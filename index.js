...
let botchannelID = require('./config.js').botchannelID;
let IdleMinerBotID = require('./config.js').IdleMinerBotID;
if (require('./config.js').token === "") return console.log(`[${moment().format('LTS')}] token is not defined. (in config.js)`);
...
bot.login(require('./config').token).catch(e => {
